...
public class jframe_tablacapaciatcion extends javax.swing.JFrame {

    public jframe_tablacapaciatcion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jframe_tablacapaciatcion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jframe_tablacapaciatcion().setVisible(true);
            }
        });
    }
