...
import plazavea.solicitudseguro.SolicitudSeguroSalud1; // Importa tu clase SolicitudSeguroSalud1
import javax.swing.JOptionPane;
import java.util.ArrayList;
import java.util.List;

public class JFrame_Solicitudaseguro extends javax.swing.JFrame {

     private List<SolicitudSeguroSalud1> solicitudes; // Lista para almacenar las solicitudes
    
    public JFrame_Solicitudaseguro() {
        initComponents();
        solicitudes = new ArrayList<>(); // Inicializa el ArrayList
    ...
    private void initComponents() {
        ...
        boton_hombre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boton_hombreActionPerformed(evt);
            }
        });
        ...
        tex_numeroruc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tex_numerorucActionPerformed(evt);
            }
        });
    ...
    private void boton_hombreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_hombreActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_boton_hombreActionPerformed

    private void boton_volverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_volverActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_boton_volverActionPerformed

    private void tex_numerorucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tex_numerorucActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tex_numerorucActionPerformed
    ...
    private void boton_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_siguienteActionPerformed
      // Obtener los datos ingresados por el usuario desde los campos de texto y otros componentes
        String razonSocial = tex_razonsocial.getText();
        String numeroRuc = tex_numeroruc.getText();
        String apellidoPaterno = tex_apellidoP.getText();
        String apellidoMaterno = tex_apellidoM.getText();
        String nombres = tex_nombres.getText();
        String tipoDocumento = combox_tipodocu.getSelectedItem().toString();
        String numeroDocumento = tex_numero.getText();
        String fechaNacimiento = tex_fecha.getText();
        String sexo = boton_hombre.isSelected() ? "Hombre" : "Mujer";
        String estadoCivil = "";
        if (boton_solter.isSelected()) {
            estadoCivil = "Soltero(a)";
        } else if (boton_casad.isSelected()) {
            estadoCivil = "Casado(a)";
        } else if (boton_divorciad.isSelected()) {
            estadoCivil = "Divorciado(a)";
        } else if (boton_viudo.isSelected()) {
            estadoCivil = "Viudo(a)";
        }
        String numeroTelefono = tex_numertelefono.getText();
        String gmail = tex_gmail.getText();
        String direccion = tex_direccion.getText();

        // Crear una instancia de SolicitudSeguroSalud1 con los datos ingresados
        SolicitudSeguroSalud1 nuevaSolicitud = new SolicitudSeguroSalud1();
        nuevaSolicitud.setRazonSocial(razonSocial);
        nuevaSolicitud.setNumeroRuc(numeroRuc);
        nuevaSolicitud.setApellidoPaterno(apellidoPaterno);
        nuevaSolicitud.setApellidoMaterno(apellidoMaterno);
        nuevaSolicitud.setNombres(nombres);
        nuevaSolicitud.setTipoDocumento(tipoDocumento);
        nuevaSolicitud.setNumeroDocumento(numeroDocumento);
        nuevaSolicitud.setFechaNacimiento(fechaNacimiento);
        nuevaSolicitud.setSexo(sexo);
        nuevaSolicitud.setEstadoCivil(estadoCivil);
        nuevaSolicitud.setNumeroTelefono(numeroTelefono);
        nuevaSolicitud.setGmail(gmail);
        nuevaSolicitud.setDireccion(direccion);

        // Agregar la nueva solicitud al ArrayList
        solicitudes.add(nuevaSolicitud);

        // Mostrar mensaje de éxito (esto es opcional, puedes modificarlo según tus necesidades)
        JOptionPane.showMessageDialog(this, "Solicitud guardada exitosamente");
    ...
    private void limpiarCampos() {
        tex_razonsocial.setText("");
        tex_numeroruc.setText("");
        tex_apellidoP.setText("");
        tex_apellidoM.setText("");
        tex_nombres.setText("");
        combox_tipodocu.setSelectedIndex(0);
        tex_numero.setText("");
        tex_fecha.setText("");
        boton_hombre.setSelected(true); // Poner por defecto seleccionado "Hombre"
        boton_solter.setSelected(true); // Poner por defecto seleccionado "Soltero(a)"
        tex_numertelefono.setText("");
        tex_gmail.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_Solicitudaseguro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new JFrame_Solicitudaseguro().setVisible(true);
            }
        });
    }
