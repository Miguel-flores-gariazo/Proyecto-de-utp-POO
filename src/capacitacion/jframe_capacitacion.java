...
public class jframe_capacitacion extends javax.swing.JFrame {
    ...
    private HashMap<Integer, capacitacion> capacitaciones;
    private JTable table;
    private DefaultTableModel tableModel;

    public jframe_capacitacion() {
        capacitaciones = new HashMap<>();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txttitulocapacitacion = new javax.swing.JTextField();
        ...
        txt_facilicitador = new javax.swing.JTextField();
        ...
        txtEspecificar = new javax.swing.JTextField();
        ...
        jCheckBoxEctintores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBoxEctintoresActionPerformed(evt);
            }
        });
        ...
        botonGuardadCAPA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonGuardadCAPAActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(6, 6, 6)
                                        .addComponent(txttitulocapacitacion, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txt_facilicitador, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addGroup(layout.createSequentialGroup()
                                                        ...
                                                        .addComponent(botonVerificar, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                    .addGroup(layout.createSequentialGroup()
                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                            .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtEspecificar, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel3)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txttitulocapacitacion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(26, 26, 26)
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel10)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txt_facilicitador, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel11)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jCheckBoxOtros)
                                    .addComponent(txtEspecificar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void botonGuardadCAPAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardadCAPAActionPerformed
          // Ejemplo de captura de datos
    String titulo = txttitulocapacitacion.getText();
    String descripcion = tex_descripcion.getText();
    String fecha = tex_fecha.getText();
    String hora = tex_hora.getText();
    String duracion = tex_duracion.getText();
    String ubicacion = txt_Ubicacion.getText();
    String facilitador = txt_facilicitador.getText();
    String contactoFaci = tex_ContacFaci.getText();
    String departamentoFaci = tex_DepartamentoFaci.getText();
    String capacidadSala = txtCapacidadSala.getText();
    String numeroAsistentes = txtNumerodeAsistentes.getText();
    String otros = txtOtros.getText();
    
    // Aquí iría la lógica para guardar los datos, por ejemplo en una base de datos
    JOptionPane.showMessageDialog(this, "Capacitación programada: " + titulo);
    }//GEN-LAST:event_botonGuardadCAPAActionPerformed

    private void jCheckBoxEctintoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxEctintoresActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCheckBoxEctintoresActionPerformed
    ...
    private javax.swing.JTextField txtEspecificar;
    ...
    private javax.swing.JTextField txt_facilicitador;
    private javax.swing.JTextField txttitulocapacitacion;
