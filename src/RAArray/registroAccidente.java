...
public class registroAccidente extends javax.swing.JFrame {
    ...
    private final Accidente[] arrayAccidentes = new Accidente[100]; // Ejemplo de tamaño 100
    private int index = 0; // Índice para manejar la posición actual en el arreglo
    ...
    private void guardarAccidente() {
        ...
        if (index < arrayAccidentes.length) { // Verificar espacio disponible en el arreglo
            arrayAccidentes[index] = accidente;
            ...
            JOptionPane.showMessageDialog(this, "No hay más espacio para guardar accidentes.", "Error", JOptionPane.ERROR_MESSAGE);
        }
        limpiarCampos();
    }
    ...
    private void eliminarAccidente() {
        ...
        if (selectedRow != -1) {
            ...
            for (int i = selectedRow; i < index - 1; i++) {
                arrayAccidentes[i] = arrayAccidentes[i + 1];
            }
            arrayAccidentes[index - 1] = null;
            index--;
    ...
    private void cargarAccidenteParaModificar() {
        int selectedRow = jTable1.getSelectedRow();
        if (selectedRow != -1 && arrayAccidentes[selectedRow] != null) {
            Accidente accidente = arrayAccidentes[selectedRow];
    ...
    private void limpiarTabla() {
        ...
        model.setRowCount(0);
        for (int i = 0; i < arrayAccidentes.length; i++) {
            arrayAccidentes[i] = null;
        }
        index = 0;
    }
