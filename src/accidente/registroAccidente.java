...
public class registroAccidente extends javax.swing.JFrame {
    ...
    String tipoAccidente = jComboBox3.getSelectedItem().toString();
    ...
    if (!idEmpleado.isEmpty() && !numeroDocumento.isEmpty() && !nombres.isEmpty()) {
            ...
            Accidente nuevoAccidente = new Accidente(idEmpleado, tipoDocumento, numeroDocumento, nombres, apellidos,
                    sexo, tipoAccidente, descripcion, fechaAccidente, fechaNacimiento);
            listaAccidentes.add(nuevoAccidente);

            // Actualizar la tabla
            Object[] rowData = {idEmpleado, tipoDocumento, numeroDocumento, nombres, apellidos,
                                fechaNacimiento, sexo, fechaAccidente, tipoAccidente, descripcion};
